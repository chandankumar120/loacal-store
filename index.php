...
<head>
    ...
    <script src="/productcontainer.js"></script>
...
<body>
    <nav class="navbar">
        ...
        <div class="navbar-right">
            <ul>
                <li><a href="#">home</a></li>
                <li class="products"><a href="#">products </a><div class="products-container">
                    <ul>
                        <li><a href="#section2">dairy</a></li>
                        <li><a href="#section2">grocery</a></li>
                        <li><a href="#section2">cosmatics</a></li>
        ...
        <div class="navbar-right">
          <ul>
            ...
            <li><input type="button" value="check" onclick="addOuter()"></li>
          </ul>
        </div>
    </nav>
